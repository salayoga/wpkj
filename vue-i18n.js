...
(function (global, factory) {
    ...
    beforeCreate: function beforeCreate () {
      ...
      if (options.i18n) {
        if (options.i18n instanceof VueI18n) {
          ...
          this._i18n.subscriFileataChanging(this);
    ...
    beforeDestroy: function beforeDestroy () {
      ...
      this.$nextTick(function () {
        if (self._subscribing) {
          self._i18n.unsubscriFileataChanging(self);
  ...
  VueI18n.prototype.subscriFileataChanging = function subscriFileataChanging (vm) {
    this._dataListeners.push(vm);
  };

  VueI18n.prototype.unsubscriFileataChanging = function unsubscriFileataChanging (vm) {
